...
## memoir-v1.3.0 — 2026-09-19

- 임시 꽃잎 심볼을 벚꽃과 네잎클로버를 결합한 네 장의 보석 꽃잎 심볼로 교체
- 컬러·단색·로크업·SVG/PNG/ICO 파비콘·앱 아이콘을 하나의 투명 마스터 윤곽에서 재생성
- 단색 심볼이 컬러 심볼과 다른 형태로 보이던 별도 패스를 제거하고 `currentColor` 필터 방식으로 통일
- PNG/ICO 파비콘과 앱 아이콘의 타일 모서리를 22% 반경의 투명 라운드로 통일
- preview 브랜드 섹션과 브라우저 캐시 버전을 1.3.0으로 갱신

## memoir-v1.2.1 — 2026-09-19

- 작은 원본 심볼을 출력 크기에 맞게 확대하도록 파비콘 및 앱 아이콘 생성 로직 수정
- winterholic-base와 같은 배경 타일형 SVG/PNG/ICO 파비콘 및 앱 아이콘으로 갱신
- preview에 심볼, 반전/단색 로고, 16·32·48px 파비콘과 앱 아이콘을 확인하는 브랜드 섹션 추가
- 브라우저 캐시 갱신을 위해 preview 자산 버전을 1.2.1로 변경

## memoir-v1.2.0 — 2026-09-19

기존 꽃잎과 마스코트를 정본으로 브랜드 자산을 완성. Plus Jakarta Sans 규격의 라이트/반전 로크업·단색 심볼·SVG/PNG/ICO 파비콘·512 앱 아이콘·1600×900 브랜드 히어로를 추가하고 Georgia+그라데이션 워드마크 불일치를 해소. 브랜드 자산 회귀 검사와 재생성 스크립트 추가.

## memoir-v1.1.0 — 2026-09-19

완성도 보강(base 수준). 06 컴포넌트 24절로 확장(탭·세그먼트·태그 입력·표·브레드크럼·더 보기·설정 행·공유 바·카운트·잔디 토큰 추가), 04·05·11·13 자립화·확장, 12 에 오류·마이페이지·설정·휴지통·태그 관리·상세 모달·공유·검색 골격 추가, **16 상황 사전** 신설.
