...
notting 의 심볼은 **잉크 페이지 위에 붙은 근거 마커**다. 검은 타일(잉크) 안에 문서 줄 셋(종이색), 오른쪽에 verdigris 세로 마커. "문서에 근거가 붙는다" — 제품의 세 번째 계약(근거 계약)을 형태로 만들었다. 흔한 흑백 이니셜이나 보라색 원형 심볼과 겹치지 않고, 16px 에서도 "줄 셋 + 막대" 실루엣이 읽힌다.
