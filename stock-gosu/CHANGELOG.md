...
## stock-gosu-v1.2.2 — 2026-09-19

- 임의 SVG path로 그렸던 단색 심볼을 실제 파랑새 원본 윤곽의 `currentColor` 마스크로 교체
- SVG 파비콘의 파랑새 가로 점유율을 87.5%에서 98.4%로 확대하고 PNG/ICO 파비콘의 내부 여백 제거
- preview 자산 버전을 1.2.2로 올려 기존 브라우저 파비콘 캐시를 갱신

## stock-gosu-v1.2.1 — 2026-09-19

- 파랑새의 옅은 외곽 광원을 제외하고 심볼 경계를 다시 계산해 작은 파비콘에서도 새가 크게 보이도록 수정
