...
winterholic의 브랜드 모티프는 **여섯 갈래 얼음 결정**이다. 차갑다는 인상보다 겨울의 정밀함·고요함·맑음을 보여준다. 로고 중심의 `W`는 브랜드 이름의 첫 글자이면서 결정의 안쪽 결합부다.

- 로고: 기하학적이고 작은 크기에서도 식별되는 형태
...
전체 미리보기는 `examples/brand-assets.html`을 브라우저로 연다.
