...
winterholic의 브랜드 모티프는 **위로 자라는 얼음 결정 군집**이다. 차갑다는 인상보다 겨울의 정밀함·고요함·맑음을 보여준다. 서로 다른 높이와 투명도를 가진 수정 기둥이 한 덩어리로 겹치는 형태를 브랜드의 인장으로 쓴다.

- 로고: 히어로 이미지의 투명한 결정 면과 빛의 깊이를 수직형 군집으로 단순화한 형태
